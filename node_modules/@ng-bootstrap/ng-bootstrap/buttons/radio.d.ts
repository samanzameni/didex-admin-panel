...
export declare class NgbRadioGroup implements ControlValueAccessor {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<NgbRadioGroup, "[ngbRadioGroup]", never, { 'name': "name" }, {}, never>;
}
/**
...
export declare class NgbRadio implements OnDestroy {
    ...
    updateDisabled(): void;
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<NgbRadio, "[ngbButton][type=radio]", never, { 'value': "value", 'disabled': "disabled", 'name': "name" }, {}, never>;
}
