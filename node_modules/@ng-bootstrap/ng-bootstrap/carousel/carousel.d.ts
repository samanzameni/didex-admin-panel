...
export declare class NgbSlide {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<NgbSlide, "ng-template[ngbSlide]", never, { 'id': "id" }, {}, never>;
}
/**
...
export declare class NgbCarousel implements AfterContentChecked, AfterContentInit, OnDestroy {
    ...
    static ngComponentDef: ɵngcc0.ɵɵComponentDefWithMeta<NgbCarousel, "ngb-carousel", ["ngbCarousel"], { 'interval': "interval", 'wrap': "wrap", 'keyboard': "keyboard", 'pauseOnHover': "pauseOnHover", 'showNavigationArrows': "showNavigationArrows", 'showNavigationIndicators': "showNavigationIndicators", 'activeId': "activeId" }, { 'slide': "slide" }, ["slides"]>;
}
/**
