...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Observable'), require('@angular/platform-browser'),require('@angular/core')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Observable', '@angular/platform-browser'], factory) :
    (factory((global.ng = global.ng || {}, global.ng.http = global.ng.http || {}),global.ng.core,global.Rx,global.ng.platformBrowser,global.ng.core));
}(this, function (exports,_angular_core,rxjs_Observable,_angular_platformBrowser,ɵngcc0) { 'use strict';
...
JSONPBackend_.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: JSONPBackend_, factory: function JSONPBackend__Factory(t) { return new (t || JSONPBackend_)(ɵngcc0.ɵɵinject(BrowserJsonp), ɵngcc0.ɵɵinject(ResponseOptions)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(JSONPBackend_, [{
        type: _angular_core.Injectable
    }], function () { return [{ type: BrowserJsonp }, { type: ResponseOptions }]; }, { _browserJSONP: [], _baseResponseOptions: [], createConnection: [] });
