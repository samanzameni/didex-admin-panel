(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/operators'), require('url'), require('rxjs'), require('@angular/common/http'),require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@auth0/angular-jwt', ['exports', '@angular/core', 'rxjs/operators', 'url', 'rxjs', '@angular/common/http','@angular/core'], factory) :
...
}(this, (function (exports, core, operators, url, rxjs, http,ɵngcc0) { 'use strict';
